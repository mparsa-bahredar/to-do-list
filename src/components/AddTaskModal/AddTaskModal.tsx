...
const AddTaskModal = ({ setTasks, setIsOpenAddModal }: { 
  ...
  return(
    <div onClick={() => {setIsOpenAddModal(false)}} className='flex justify-center items-center bg-black/30 fixed inset-0'>
        <div className='flex flex-col gap-4 p-6 bg-[#FFFFFF] shadow-[0_0_8px_rgba(0,0,0,0.1)] rounded-xl   dark:bg-gray-600'>
                ...
                <div className='flex flex-col gap-4'>
                    <div className='flex flex-col gap-2'>
                        ...
                        <input
                            ...
                            className='w-[400px] h-9 pl-2 font-regular text-sm text-left text-[#525252] bg-[#F5F5F5] outline-none focus:ring-2 
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <div className='flex gap-2'>
                            <input
                                ...
                                className='w-full h-9 pl-2 font-regular text-sm text-[#525252] bg-[#F5F5F5] outline-none focus:ring-2 
                                focus:ring-[#E4E4E4] rounded-lg dark:text-[#F5F5F5] dark:bg-gray-500'
                            />
                            <button
