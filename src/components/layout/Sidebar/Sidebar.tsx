...
const Sidebar = ({handleOpenMenu}: IProps) => {
    ...
    return (
        <>
            ...
            <div className={`flex flex-col gap-6 p-6 bg-[#FFFFFF] absolute top-0 z-60
            ${locale === "en" ? "left-0 rounded-r-[12px]" : "right-0 rounded-l-[12px]"}`}>
                <div onClick={() => {handleOpenMenu(false)}} className="text-[#262626] cursor-pointer">
                    Close
                </div>
                <div className="flex flex-col gap-4 font-medium text-[#262626]   dark:text-[#F5F5F5]">
