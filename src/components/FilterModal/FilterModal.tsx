...
const FilterModal = ({ filters, setFilters, setIsOpenFilterModal }: { 
  ...
  return (
    <div className='flex flex-col gap-4 p-6 bg-[#FFFFFF] shadow-[0_0_8px_rgba(0,0,0,0.1)] rounded-xl absolute top-12 left-0 z-50
    dark:bg-gray-600'>
      <div className='flex justify-between items-center'>
        <h3 className='font-semibold text-[#404040]   dark:text-[#F5F5F5]'>Filters</h3>
